...
export const Greeting = () => {
  return (
    ...
    >
      ...
      >
        <span className="bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500 bg-clip-text text-balance text-transparent dark:from-amber-300 dark:via-orange-300 dark:to-pink-300">
          Хочешь в Летово?
        </span>
      </motion.div>
      <motion.div
